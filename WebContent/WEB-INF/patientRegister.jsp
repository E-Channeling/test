							...
							<div class="row h-100">
								<div
									...
									<header class="entry-header">
										...
										<form  class="form-signin" target="_self" action="" style="border-radius: 10px; padding: 30px;background-color: white;box-shadow: 2px 2px 2px 2px rgb(194, 194, 194);"> 
									        <center><i class="fa fa-user-circle" style="font-size:66px;color:blue"></i></center>
									        ...
									        <input type="date" class="form-control" placeholder="DOB" required autofocus name="DOB">
									        <label>Gender</label>
									        <input type="text" class="form-control" placeholder="Gender" required autofocus name="gender">
									        <label>Phone Number</label>
									        <input type="number"  class="form-control" placeholder="Phone Number" required autofocus name="phoneNo">
									        <label>Address</label>
									        <input type="text" class="form-control" placeholder="Address" required autofocus name="address">
									      ...
									      <a id="fpwd" href="#">New Patient Register</a>
									    </form>
