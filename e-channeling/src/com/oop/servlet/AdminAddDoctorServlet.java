...
/**
 * Servlet implementation class AdminAddDoctorServlet
 */
@WebServlet("/AdminAddDoctorServle")
public class AdminAddDoctorServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(doctorArrayList.isEmpty()) {
			...
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/adminAddDoctor.jsp");
			dispatcher.forward(request, response);
		}
